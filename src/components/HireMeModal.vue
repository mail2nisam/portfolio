					...
					>
						...
						>
							...
							<div class="modal-body p-5 w-full h-full">
								<form class="max-w-xl m-4 text-left">
									...
									<div class="mt-7 pb-4 sm:pb-1">
										<Button
											title="Send Request"
											class="px-4 sm:px-6 py-2 sm:py-2.5 text-white bg-lime-500 hover:bg-lime-600 rounded-md focus:ring-1 focus:ring-lime-900 duration-500"
											type="submit"
							...
							>
								<Button
									title="Close"
									class="px-4 sm:px-6 py-2 bg-gray-600 text-primary-light hover:bg-ternary-dark dark:bg-gray-200 dark:text-secondary-dark dark:hover:bg-primary-light rounded-md focus:ring-1 focus:ring-lime-900 duration-500"
									@click="showModal()"
