		...
		<div class="w-full md:w-1/3 text-left">
			...
			<div class="flex justify-center sm:block">
				<a
					...
					class="flex justify-center items-center w-36 sm:w-48 mt-12 mb-6 sm:mb-0 text-lg border border-lime-200 dark:border-ternary-dark py-2.5 sm:py-3 shadow-lg rounded-lg bg-lime-50 focus:ring-1 focus:ring-lime-900 hover:bg-lime-500 text-gray-500 hover:text-white duration-500"
